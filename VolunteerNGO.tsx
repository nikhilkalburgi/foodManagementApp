...
export default function VolunteerNGO({navigation,route}: {navigation: any,route:any}) {
    const selectedIndex = React.useRef(new Animated.Value(1)).current;
    const [items, setItems] = React.useState([{id:1,name:"Volunteers"},{id:2,name:"Requests"},{id:3,name:"Accepted"},{id:4,name:"Map"}] );
